...
export const metadata: Metadata = {
  title: "개인정보처리방침",
  description: "강원특별자치도 보조기기센터 개인정보처리방침",
...
const articles = [
  {
    title: "제 1조 목적",
    content: `이 약관은 강원특별자치도 보조기기센터(이하 "회사")가 제공하는 회사의 제반 서비스 이용과 관련하여 회사와 회원과의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.`,
  },
  {
    title: "제 2조 정의",
...
⑥ 비밀번호 : 회원이 부여 받은 아이디와 일치되는 회원임을 확인하고 비밀보호를 위해 회원 자신이 정한 문자 또는 숫자의 조합을 의미함`,
  },
  {
    ...
    content: `① 회사는 이 약관의 내용을 회원이 쉽게 알 수 있도록 서비스 초기 화면에 게시합니다.
...
⑥ 새로운 서비스가 개설될 경우 별도의 명시된 설명이 없는 한 이 약관에 따라 제공합니다.`,
  ...
  {
    title: "제 4조 이용계약 체결",
    content: `① 이용계약은 회원이 되고자 하는 자(이하 가입신청자)가 약관의 내용에 대하여 동의를 한 다음 회원가입신청을 하고 회사가 이러한 신청에 대하여 승낙함으로써 체결됩니다.
...
② 회원은 회원가입신청 시 기재한 사항이 변경되었을 경우 즉시 온라인으로 수정해야하며, 변경 사항을 수정하지 않아 발생한 불이익에 대하여 회사는 책임지지 않습니다.`,
  ...
  {
    title: "제 6조 개인정보보호 의무",
    content: `회사는 정보통신망법 등 관계 법령이 정하는 바에 따라 회원의 개인정보를 보호하기 위해 노력합니다. 개인정보의 보호 및 사용에 대해서는 관련법 및 회사의 개인정보처리방침이 적용됩니다. 다만, 회사의 공식 사이트 이외의 링크된 사이트에서는 회사의 개인정보처리방침이 적용되지 않습니다.`,
  },
  {
    title: "제 7조 회원의 아이디 및 비밀번호의 관리에 대한 의무",
...
④ 제3항의 경우에 해당 회원이 회사에 그 사실을 통지하지 않거나, 통지한 경우에도 회사의 안내에 따르지 않아 발생한 불이익에 대하여 회사는 책임지지 않습니다.`,
  ...
  {
    title: "제 8조 연결서비스와 피연결서비스 간의 관계",
    content: `① 상위 서비스와 하위 서비스가 하이퍼링크(예: 하이퍼링크의 대상에는 문자, 그림 및 동화상 등이 포함됨)방식 등으로 연결된 경우, 전자를 연결서비스(웹 사이트)이라고 하고 후자를 피연결서비스(웹사이트)이라고 합니다.
...
② 연결서비스는 피연결서비스가 독자적으로 제공하는 재화 등에 의하여 이용자와 행하는 거래에 대해서 보증책임을 지지 않는다는 뜻을 연결서비스의 초기화면 또는 연결되는 시점의 팝업화면으로 명시한 경우에는 그 거래에 대한 보증책임을 지지 않습니다.`,
  },
  {
    ...
    content: `① 회사가 회원에 대한 통지를 하는 경우 이 약관에 별도 규정이 없는 한 회원이 회사와 미리 약정하여 지정한 전자우편주소로 할 수 있습니다.

② 회사는 회원 전체에 대한 통지의 경우 7일 이상 회사의 게시판에 게시함으로써 제1항의 통지에 갈음할 수 있습니다.`,
  },
  {
    title: "제 10조 회사의 의무",
    content: `① 회사는 관련법과 이 약관이 금지하거나 미풍양속에 반하는 행위를 하지 않으며, 계속적이고 안정적으로 서비스를 제공하기 위하여 최선을 다하여 노력합니다.
...
③ 회사는 무료로 제공되는 서비스의 일부 또는 전부를 회사의 정책 및 운영의 필요상 수정, 중단, 변경할 수 있으며, 이에 대하여 관련법에 특별한 규정이 없는 한 회원에게 별도의 보상을 하지 않습니다.`,
  ...
  {
    title: "제 14조 정보의 제공 및 광고의 게재",
    content: `① 회사는 회원이 서비스 이용 중 필요하다고 인정되는 다양한 정보를 공지사항이나 전자우편 등의 방법으로 회원에게 제공할 수 있습니다. 다만, 회원은 관련법에 따른 거래관련 정보 및 고객문의 등에 대한 답변 등을 제외하고는 언제든지 전자우편에 대해서 수신 거절을 할 수 있습니다.
...
④ 이용자(회원, 비회원 포함)는 회사가 제공하는 서비스와 관련하여 게시물 또는 기타 정보를 변경, 수정, 제한하는 등의 조치를 취하지 않습니다.`,
  },
  {
    ...
    content: `① 회원이 회사의 서비스 내에 게시한 게시물의 저작권은 해당 게시물의 저작자에게 귀속됩니다.
...
③ 회사는 제2항 이외의 방법으로 회원의 게시물을 이용하고자 하는 경우에는 전화, 팩스, 전자우편 등을 통해 사전에 회원의 동의를 얻어야 합니다.`,
  ...
  {
    title: "제 16조 할인 쿠폰의 사용",
    content: `① 회사는 구매서비스를 이용하는 회원에게 상품 구매 시 일정금액 또는 일정비율을 할인 받을 수 있는 할인 쿠폰을 발급할 수 있습니다.
...
⑤ 할인 쿠폰은 그 사용대상. 방법. 기한 및 제한사항 등은 회사의 관련화면(초기화면, 연결화면 포함, 이하 동일) 및 할인쿠폰 등에 개별 표시되고, 할인쿠폰의 종류 및 내용은 회사정책에 따라 달라질 수 있습니다.`,
  ...
  {
    title: "제 17조 계약해제, 해지, 휴면 등",
    content: `① 회원은 언제든지 마이페이지 관리 메뉴 등을 통하여 이용계약 해지 신청을 할 수 있으며, 회사는 관련법 등이 정하는 바에 따라 이를 즉시 처리하여야 합니다. 다만, 기업회원의 경우 대표ID는 탈퇴할 수 없으며, ID관리 메뉴에서 담당자ID에 대표 권한을 이관하신 후에 탈퇴하실 수 있습니다.
  ...
  return (
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
      <Breadcrumb
        ...
        className="mb-6"
      />
      <h1 className="text-responsive-xl font-bold text-foreground mb-2">개인정보처리방침</h1>
      <p className="text-sm text-muted-foreground mb-8">시행일: 2016년 10월 15일</p>

      <div className="space-y-8 max-w-3xl">
        {articles.map((article) => (
          <section key={article.title}>
            <h2 className="text-base font-bold text-foreground mb-3 pb-2 border-b">
              {article.title}
            </h2>
        ...
        <div className="mt-10 pt-6 border-t text-sm text-muted-foreground">
          <p className="font-medium text-foreground">(부칙)</p>
          <p>이 약관은 2016년 10월 15일부터 적용됩니다. 종전의 약관은 본 약관으로 대체합니다.</p>
        </div>
      </div>
    </div>
  )
