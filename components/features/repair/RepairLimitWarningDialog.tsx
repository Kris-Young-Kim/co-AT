...
interface RepairLimitWarningDialogProps {
  open: boolean
 ...
 * 수리비 한도 경고 다이얼로그
 */
export function RepairLimitWarningDialog({
  open,
  onOpenChange,
  currentTotal,
  newAmount,
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription className="space-y-2 pt-2">
            <p>
              해당 대상자의 올해 수리비 누적 금액이 <strong>{formatCurrency(limit)}</strong> 한도를 초과합니다.
            </p>
            ...
            <p className="text-xs text-muted-foreground mt-2">
              수리비는 연간 10만원으로 제한됩니다. 계속 진행하시겠습니까?
            </p>
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
